...
import com.illiarb.tmdbclient.details.presentation.MovieDetailsView
import com.illiarb.tmdbclient.details.ui.photos.PhotosAdapter
...
class MovieDetailsFragment : BaseFragment(), MovieDetailsView, Injectable {
    ...
    override val movieCollector: FlowCollector<Movie>
        get() = emit { showMovieDetails(it) }
    ...
    override fun reviewsClick(): Flow<Unit> = movieDetailsReviews.clicks
