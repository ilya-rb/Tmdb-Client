...
fun movieSectionDelegate(
    ...
    val adapter = MovieSectionAdapter(imageLoader, onClick)
    ...
    RecyclerViewBuilder
        .create {
            ...
            hasFixedSize(true)
            spaceBetween { spacing = itemView.resources.getDimensionPixelSize(R.dimen.spacing_normal) }
        }
...
class MovieSectionAdapter(
    ...
    init {
        delegatesManager.addDelegate(movieDelegate(imageLoader, onClick))
    }
