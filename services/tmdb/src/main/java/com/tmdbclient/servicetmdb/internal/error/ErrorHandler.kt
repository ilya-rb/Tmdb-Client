package com.tmdbclient.servicetmdb.internal.error

import com.google.gson.Gson
import com.illiarb.tmdbclient.util.ApiException
import com.illiarb.tmdbclient.util.NetworkException
import com.illiarb.tmdbclient.util.UnknownErrorException
...
class ErrorHandler @Inject constructor(
  ...
  private val resourceResolver: com.illiarb.tmdbclient.tools.ResourceResolver
) {
