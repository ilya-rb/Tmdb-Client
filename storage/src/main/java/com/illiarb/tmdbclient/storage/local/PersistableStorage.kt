...
class PersistableStorage @Inject constructor(app: App) {
    ...
    fun getMoviesByType(type: String): List<MovieModel> = getValue(type, MovieListModel()).movies

    fun getCurrentAccount(): AccountModel = getValue(KEY_ACCOUNT, AccountModel())
